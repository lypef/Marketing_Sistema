                    ...
                    <ul>
                      ...
                      <li class="nav-item"><a href="#" target="_self">Promociones</a>
                        <ul>
                          ...
                          <li><a href="/index.php/all/promotions?id_img=0&pag=1" target="_self">Ver promociones</a></li>  
                        </ul>
                      </li>
      ...
      <?php if ($_SERVER["REQUEST_URI"] == '/' || $_SERVER["REQUEST_URI"] == '/index.php')
      {
        ...
        <div class="featured-slider">
          <div id="bannerflexslider" class="flexslider">
            <ul class="slides">
            <li>
            <img src="../../public/images/webpage.gif" class="attachment-slider size-slider wp-post-image" alt="slider1" />
            </li>
            </ul>
          </div>
        </div>
