<main id="main" class="site-main">
      <div class="container">
        <div id="primary" class="">
            ...
            <h2 class="idol-title">SABEMOS QUE NO TODAS LAS EMPRESAS TIENEN LAS MISMAS NECESIDADES, POR ELLO, CONTAMOS CON DIFERENTES SERVICIOS</h2>
            <div class="row">
            


        <div class="card card col-sm-4">
            <img class="card-img-top" src="https://www.optimizacion-online.com/wp-content/uploads/2016/01/dreamstime_s_44011553.jpg" alt="Card image" style="width:100%">
            <div class="card-body">
                <br>
                ...
                <div align="right">
                <a class="btn btn-primary" href="/index.php/all/nuestros_servicios_publicidad"  title="Publicidad">Ver mas !</a>
                </div>
                <br>
            </div>
            </div>
            ...
            <div class="card card col-sm-4">
            <img class="card-img-top" src="https://rhocasac.com/wp-content/uploads/2018/05/3-gestion-y-desarrollo.jpg" alt="Card image" style="width:100%">
            <div class="card-body">
                <br>
                ...
                <div align="right">
                <a class="btn btn-primary" href="/index.php/all/nuestros_servicios_desarrollo" title="Desarrollo">Ver mas !</a>
                </div>
                <br>
            </div>
            </div>
            ...
            <div class="card card col-sm-4">
            <img class="card-img-top" src="http://sistemarecursoshumanos.com/wp-content/uploads/2017/10/Gestion-de-Recursos-Humanos-min.png" alt="Card image" style="width:100%">
            <div class="card-body">
                <br>
                ...
                <div align="right">
                <a class="btn btn-primary" href="/index.php/all/nuestros_servicios_gestion" title="Gestion">Ver mas !</a>
                </div>
            </div>
            </div>
...
#generic_price_table .generic_content:hover .generic_head_price .generic_head_content .head_bg{
	border-color: #0c91cd rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #0c91cd;
	color: #fff;
}
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_price_btn clearfix">
                        	<a class="" href="/index.php/all/contacto?asunto=Servicio: Banner&servicio=Banner">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
                ...
                <div class="col-md-4">
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                            <a class="" href="/index.php/all/contacto?asunto=Servicio: Afiliados&servicio=Afiliados">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
                ...
                <div class="col-md-4">
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                            <a class="" href="/index.php/all/contacto?asunto=Servicio: Codigo Qr&servicio=Codigo Qr">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                        	<ul>
                                ...
                                <li><span>Alcance aproximado de 40 a 60 mil personas</span></li>    
                            </ul>
                        </div>
                        <!--//FEATURE LIST END-->
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                            <a class="" href="/index.php/all/contacto?asunto=Servicio: Contenido&servicio=Contenido">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                        	<ul>
                                ...
                                <li><span>Público seleccionado para tener un mejor resultado en ventas</span></li>
                            </ul>
                        </div>
                        <!--//FEATURE LIST END-->
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                            <a class="" href="/index.php/all/contacto?asunto=Servicio: Facebook Live&servicio=Facebook Live">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                        	<ul>
                                ...
                                <li><span>Publicidad impresa o digital</span></li>
                            </ul><br>
                        </div>
                        <!--//FEATURE LIST END-->
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                            <a class="" href="/index.php/all/contacto?asunto=Servicio: Fotografia&servicio=Fotografia">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
            ...
            <div class="row">
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                        	<ul>
                                ...
                                <li><span>Entrevista al dueño o encargado</span></li>
                                <li><span>Duración de 2 a 5 minutos</span></li>
                                <li><span>Publicado en redes sociales</span></li>
                                <li><span>Forma segmentada para un mayor alcance de clientela</span></li>
                            </ul>
                        </div>
                        <!--//FEATURE LIST END-->
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                            <a class="" href="/index.php/all/contacto?asunto=Servicio: Video&servicio=Video">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                        	<ul>
                                ...
                                <li><span>Dominio incluido</span></li>
                                <li><span>Servidor incluido</span></li>
                                <li><span>Hosting incluido</span></li>
                                <li><span>Correos personalizados incluidos</span></li>
                                <li><span>Gratis al contratar cualquier servicio por un año</span></li>
                            </ul>
                        </div>
                        <!--//FEATURE LIST END-->
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                            <a class="" href="/index.php/all/contacto?asunto=Servicio: Pagina Web&servicio=Pagina Web">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
                ...
                <div class="col-md-4">
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                            <a class="" href="/index.php/all/contacto?asunto=Servicio: Administracion de Redes&servicio=Administracion de Redes">Postularme</a>
                        </div>
                        <!--//BUTTON END-->
...
<p>
* Precios a clientes con 2 o más servicios contratados, la contratación de paquetes no aplica para descuento.<br>
** Precios a clientes con sólo un servicio contratado, la contratación de paquetes no aplica para descuento.
</p>